...
이때 잡음은 AWGN으로 가정 <img src="./images/AWGN.PNG" width="15%" height="15%"/></p>
채널은 Rayleigh 페이딩을 가정 <img src="./images/Rayleigh.png" width="15%" height="15%"/></p>
...
-> 이진 대척 신호는 2진 위상 modulation(변조)이고 이는 위상 변조
