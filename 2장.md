...
한 쌍의 시간 샘플에 대해 xA 또는 xB 전송할때, <p align="center"><img src="./images/xa.png" width="15%" height="15%"/></p>
다음 식을 기반으로 수신 신호를 탐지하길 원한다 <p align="center"><img src="./images/y.png" width="15%" height="15%"/></p>

이는 간단한 hypothesis testing (가설 검정) 문제이며 Maximum likelihood (ML) 규칙은 이렇게 도출할 수 있다.
<p align="center"><img src="./images/ML.png" width="15%" height="15%"/></p>

ratio는 <p align="center"><img src="./images/loglike.png" width="15%" height="15%"/></p>
